...
SPM-78. Case tables live in the team test-case document. This folder is
the run guide.
...
and the equipment epic (SPM-2, SPM-3, SPM-4, SPM-75 through SPM-78).
Use the story commands as their contracts.
...
SPM-45 through SPM-78 use valid credentials only. Invalid login is 401;
